import { Brain, BarChart3, Users, Lightbulb, ArrowRight, Mail, Phone, MapPin } from 'lucide-react';
      ...
      <header className="bg-gradient-to-r from-blue-600 to-indigo-700 text-white">
        <nav className="container mx-auto px-6 py-4 flex justify-between items-center">
          ...
          <div className="hidden md:flex space-x-8">
            <a href="#solucoes" className="hover:text-blue-200 transition">Soluções</a>
            <a href="#beneficios" className="hover:text-blue-200 transition">Benefícios</a>
        ...
        <div className="container mx-auto px-6">
          <div className="flex flex-col md:flex-row justify-between items-center">
            ...
            <div className="text-gray-400 text-sm">
              © 2024 IA Solutions. Todos os direitos reservados.
            </div>
          </div>
        </div>
      </footer>
